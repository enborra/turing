...
# Vox on an OSX machine. This script will not function properly
...
SCRIPT_ORIGIN=$TURING_APP_DIR/services/display/system/com.turing.vox.plist
SCRIPT_LAUNCHD_LOCATION=/Library/LaunchDaemons/com.turing.vox.plist
