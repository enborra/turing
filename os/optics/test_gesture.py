    ...
    try:
        ...
        if len(hands) > 0:
            for( hand_x, hand_y, hand_w, hand_h ) in hands:
                ...
                # crop_img = img[hand_y:hand_y+hand_h, hand_x:hand_x+hand_w]
                #
                ...
                #
                # cv2.putText(curr_frame,str(count_defects) + " detected", (50,50), cv2.FONT_HERSHEY_SIMPLEX, 2, 2)
                #
